...
namespace UnityEditor.Rendering.Universal
{
    internal partial class UniversalRenderPipelineAssetUI
    {
        internal static class Styles
        {
            ...
            // ys custom start
            public static GUIContent meshLodBiasText = EditorGUIUtility.TrTextContent("Mesh LOD Bias", "Applies a global bias to all Mesh LOD on Mesh Renderers. NOTE: This doesn't apply to Skinned Mesh Renderers. It also isn't taken into account by the labels rendered in the scene view, as those utilize a C++ function from LODUtility that we can't change.");
            public static GUIContent shadowMeshLodBiasText = EditorGUIUtility.TrTextContent("Shadow Mesh LOD Bias", "Applies a separate global bias to all Mesh LOD meshes on Mesh Renderers when rendering shadows. This value is set absolutely -- it is NOT additive with Mesh LOD Bias.");
            // ys custom end
